...
jQuery(document).ready(function($) {
    ...
    jQuery('.testimonial-wrapper').bxSlider({
        auto: !0,
        autoDelay: 2000,
        pause: 7000,
        mode: 'fade',
...
disableScroll();
win.load(function() {
    jQuery.when(jQuery("#overlayer").delay(2000).queue(function(next) {
...
function scrollFunction() {
    if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
        document.getElementById("logotext11").style.visibility = "hidden";
        document.getElementById("logotext11").style.transition = "1s";
    } else {
        document.getElementById("logotext11").style.visibility = "visible";
        document.getElementById("logotext11").style.transition = "1s";

    }
}

$('#top-nav-inline .primary-menu a').on('click', function() {
    $('#top-nav-inline .primary-menu').find('li.active').removeClass('active');
